...
function SwitchSection() {
  ...
  const testMutation = useMutation({
    mutationFn: () => api.runSwitchTest(),
    onSuccess: () => {
      toast({ title: "Test emails sent to your address. Check your inbox.", variant: "success" });
    },
    onError: (err) => {
      toast({ title: err instanceof APIError ? err.message : "Test failed", variant: "destructive" });
    },
  });
